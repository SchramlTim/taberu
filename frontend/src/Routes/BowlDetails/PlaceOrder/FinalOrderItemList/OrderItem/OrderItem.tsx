...
function OrderItem(props: {item: OrderItemInBasketContext}) {
    ...
    return (
        <>
            <div
                className={'flex flex-wrap justify-between mt-3 rounded w-full bg-gray-200'}
            >
                ...
                >
                  {!editMode ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                {props.item.additionalInformation.length > 0 && !editMode && <div className={'w-full px-2 pb-2'}>
