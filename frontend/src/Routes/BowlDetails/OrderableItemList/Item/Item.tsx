...
function Item(props: { item: MenuItemProps }) {
    ...
    return (
        <>
            <div
                className={
                    'flex justify-between rounded w-full overflow-x-hidden shadow-black transtion-color duration-100 ' +
                    (selfSelectList.length > 0 ? 'bg-green-300' : 'bg-gray-200')
                }
            >
                <div
                    className={
                        'w-8/12 flex gap-2 flex-wrap justify-between p-2'
                    }
                    onClick={() => {
                ...
                >
                    <div className={'flex flex-col'}>
                        ...
                        <span className={'break-all'}>
                            {item.description} dasdasad
                        </span>
                    </div>
                    <span
                        className={
                            'flex justify-center items-center break-all text-right'
                        }
                    >
